    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8 ">
                ...
                <p class="text-base leading-relaxed text-gray-600 mt-7">Expert diagnostics ensure accurate identification, thorough analysis, and effective resolution of even the most complex issues with precision and efficiency.</p>
            ...
            <div>
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Our Service</p>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Login </a>
                    </li>
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Admin Login </a>
                    </li>
                </ul>
            </div>
  ...
  <a href="#" title="" class="flex text-[11px] text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
    <p>Expert diagnostics ensure accurate identification, thorough </p>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Enter Your Email</p>
                ...
                <form action="#" method="POST" class="mt-6">
                    ...
                    <button type="submit" class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700">Click Me</button>
                </form>
            </div>
        </div>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by Expert Diagnostics</p>
    </div>
</section>
  )
}
