    ...
    <div className="whatisPFT-container">
          ...
          <div className="whatisPFT-text">
            ...
            <div className="whatisPFT-list">
              <p>
              A Pulmonary Function Test is a non-invasive test that measures how well the lungs work, including their capacity, airflow, and gas exchange. It helps diagnose respiratory conditions like asthma, COPD, and other lung disorders. PFTs also monitor the effectiveness of treatments and track disease progression.              </p>
              <div className="whatisPFT-scanlist">
                <ul>
                  ...
                  <li>
                    <span className="check-icon">✔</span>
                    Diagnoses and monitors respiratory conditions like asthma or COPD.
                  </li>
                  <li>
                    <span className="check-icon">✔</span>
